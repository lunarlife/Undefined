...
using FontStyle = UndefinedNetworking.GameEngine.UI.Elements.Enums.FontStyle;
using TextAlignment = UndefinedNetworking.GameEngine.UI.Elements.Enums.TextAlignment;
using TextOverflow = UndefinedNetworking.GameEngine.UI.Elements.Enums.TextOverflow;
...
namespace GameEngine
{
    public static class UnityExtensions
    {
            ...
            this TextAlignment alignment) => alignment switch
        {
            ...
            TextAlignment.CenterJustified => (VerticalAlignmentOptions.Middle, HorizontalAlignmentOptions.Justified),
            ...
            TextAlignment.BottomJustified => (VerticalAlignmentOptions.Bottom, HorizontalAlignmentOptions.Justified),
        ...
        public static TextOverflowModes ToUnityOverflow(this TextOverflow overflow) => overflow switch
        {
        ...
        public static GridLayoutGroup.Axis ToUnityAxis(this Axis axis) => axis switch
        {
        ...
        public static MouseKey? ToMouseKey(this KeyCode code) => code switch
        {
        ...
        public static KeyboardKey? ToKeyboardKey(this KeyCode code) => code switch
        {
        ...
        public static GridLayoutGroup.Constraint ToUnityConstraint(this Constraint constraint) => constraint switch
        {
        ...
        public static TextAnchor ToUnityAlingnment(this Alignment alignment) => alignment switch
        {
        ...
        public static GridLayoutGroup.Corner ToUnityCorner(this Corner alignment) => alignment switch
        {
        ...
        public static Dot2Int ToDot(this Vector3Int dot2) => new(dot2.x, dot2.y);
    }
}
