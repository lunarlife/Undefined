...
namespace GameEngine.GameObjects
{
    public class Text
    {
        ...
        public Text(Rect rect, FontSize size, Color? color = null, TextWrapping? wrapping = null, string content = "", string name = "", UIBind? bind = null, int layer = 0, Side pivot = Side.Center, Margins? margins = null)
        {
